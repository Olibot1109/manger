  ...
  filtered.forEach(function(entry) {
    ...
    row.innerHTML =
      ...
      '<td data-user="' + escapeHtml(user) + '">' +
        ...
        '<div class="action-group clear-group"><button class="action-button btn-clear-cookies" title="Ask this client to clear its cookies and reload">Unauth</button><button class="action-button btn-add-cookies" title="Ask this client to clear its cookies and reload">Auth</button><button class="action-button btn-img">Image ^</button></div>' +
